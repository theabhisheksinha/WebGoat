...
public class WSDLScanning extends LessonAdapter
{
	 ...
	 * Replaces vulnerable Apache Axis 1.2 SOAP client to resolve cloud blockers:
	 * - CAST 1200236 (Critical): Deprecated language/framework version
	 * - CAST 1200374 (High): JAX-RPC technology
	 * - CAST 1200377 (High): Java RMI
	 */
